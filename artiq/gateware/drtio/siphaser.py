...
class SiPhaser7Series(Module, AutoCSR):
    def __init__(self, si5324_clkin, si5324_clkout_fabric,
        ...
        # rtio_clk_freq to rtio_clk_freq with controllable phase shift,
        # VCO @ 1200MHz (150 MHz) or 1250 MHz (125 MHz)
        ...
        self.specials += \
            Instance("MMCME2_ADV",
                ...
                p_CLKFBOUT_MULT_F=10.0 if rtio_clk_freq==125e6 else 8.0,
                p_CLKOUT0_DIVIDE_F=10.0 if rtio_clk_freq==125e6 else 8.0,
                p_DIVCLK_DIVIDE=1,
